...
public class ClassSectionController {
    ...
    public ResponseEntity<ClassSectionResponse> assignTeacherToClassSection(@PathVariable UUID id,
    ...
    @GetMapping("/by-semester-and-subject")
    public ResponseEntity<List<ClassSectionResponse>> getClassSectionsBySemesterAndSubject(
