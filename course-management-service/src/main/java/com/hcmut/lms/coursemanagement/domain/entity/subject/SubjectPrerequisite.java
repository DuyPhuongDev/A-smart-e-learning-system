...
public class SubjectPrerequisite extends BaseEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumns({
        @JoinColumn(name = "prere_curriculum_subject_id", referencedColumnName = "id", insertable = false, updatable = false),
        @JoinColumn(name = "prere_subject_id", referencedColumnName = "subject_id", insertable = false, updatable = false),
        @JoinColumn(name = "prere_curriculum_section_id", referencedColumnName = "curriculum_section_id", insertable = false, updatable = false)
    })
    private CurriculumSubject prerequisiteCurriculumSubject;
}
