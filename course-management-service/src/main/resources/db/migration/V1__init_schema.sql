...
ALTER TABLE course_management.chapters ADD CONSTRAINT uk_class_section_chapter_order UNIQUE (class_section_id, order_index);
...
ALTER TABLE course_management.lectures ADD CONSTRAINT uk_chapter_lecture_order UNIQUE (chapter_id, order_index);
