...
import com.hcmut.lms.personalization.application.entity.OnetFlattenedRequirementEmbedding;
...
@Repository
public interface OnetFlattenedRequirementEmbeddingRepository extends JpaRepository<OnetFlattenedRequirementEmbedding, UUID> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    void upsertEmbedding(@Param("requirementId") UUID requirementId,
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    ValuationSummaryRow computeValuationSummary(@Param("sloVectorLiterals") String[] sloVectorLiterals,
                                                @Param("occCode") String occupationCode,
    ...
    @Query(value = """
            ...
            limit :topK
            """, nativeQuery = true)
    List<ValuationTopMatchRow> findTopMatches(@Param("sloVectorLiterals") String[] sloVectorLiterals,
                                              @Param("occCode") String occupationCode,
                                              @Param("threshold") double threshold,
                                              @Param("topK") int topK);
}
