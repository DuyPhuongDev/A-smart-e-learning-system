...
public interface OnetFlattenedRequirementRepository extends JpaRepository<OnetFlattenedRequirement, java.util.UUID> {
  ...
  @Query("""
      ...
      """)
  List<OnetFlattenedRequirement> findByOccupation_OnetsocCodeIn(
      @Param("occupationCodes") Collection<String> occupationCodes);
  ...
  @Query("""
      ...
      order by o.onetsocCode, r.onetFlattenedRequirementsId
      """)
  List<OnetFlattenedRequirement> findMissingEmbeddingsByOccupationCodes(
      @Param("occupationCodes") Collection<String> occupationCodes, Pageable pageable);
