...
ON CONFLICT (email) DO NOTHING;
INSERT INTO user_management.students (user_id, student_code, intake_year_id, department_id)
VALUES ('9b2c7d39-bc76-41ec-8586-d64cbc18775b', '2110002', '9ab1203e-27f6-4aa9-8f91-3a1980b03ba8', 'f6f1f3bd-cb99-4ec2-8a45-16d59c2c1371')
ON CONFLICT (student_code) DO NOTHING;
...
ON CONFLICT (email) DO NOTHING;
INSERT INTO user_management.students (user_id, student_code, intake_year_id, department_id)
VALUES ('37f5a1d9-83ab-45c4-85de-0205d1ca1a0b', '2110003', '9ab1203e-27f6-4aa9-8f91-3a1980b03ba8', 'f6f1f3bd-cb99-4ec2-8a45-16d59c2c1371')
ON CONFLICT (student_code) DO NOTHING;
...
ON CONFLICT (email) DO NOTHING;
INSERT INTO user_management.students (user_id, student_code, intake_year_id, department_id)
VALUES ('94bc2015-b87f-45ac-8b95-a7b45f2faa47', '2110004', '9ab1203e-27f6-4aa9-8f91-3a1980b03ba8', 'f6f1f3bd-cb99-4ec2-8a45-16d59c2c1371')
ON CONFLICT (student_code) DO NOTHING;
...
ON CONFLICT (email) DO NOTHING;
INSERT INTO user_management.students (user_id, student_code, intake_year_id, department_id)
VALUES ('4d3f8e19-d6f8-475f-b534-ffec14382540', '2110005', '9ab1203e-27f6-4aa9-8f91-3a1980b03ba8', 'f6f1f3bd-cb99-4ec2-8a45-16d59c2c1371')
ON CONFLICT (student_code) DO NOTHING;
