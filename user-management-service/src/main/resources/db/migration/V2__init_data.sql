...
ON CONFLICT (email) DO NOTHING;
INSERT INTO user_management.users (id, email, avatar_url, first_name, last_name, phone, last_login, specialization_id, role_id, created_at, updated_at) VALUES ('8f06fef7-9024-43f9-9bbc-cf89b9d063c1', 'student1@hcmut.edu.vn', NULL, 'Van', 'A', '0901234567', NULL, 1, 'e5909d1e-492d-4419-9766-ce69821e28ec', '2026-01-15 08:06:49.849703+00', '2026-01-15 08:06:49.849717+00')
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO user_management.outbox (id, aggregate_type, aggregate_id, type, payload, created_at) VALUES ('e4bbd766-564e-427c-8a8c-ccbdd408085f', 'user', '8f06fef7-9024-43f9-9bbc-cf89b9d063c1', 'UserCreated', '{"email": "student1@hcmut.edu.vn", "userId": "8f06fef7-9024-43f9-9bbc-cf89b9d063c1", "eventId": "08fe2427-c740-47de-9a76-d17ee4e2c750", "password": "password123", "roleName": "STUDENT", "timestamp": "2026-01-15T15:06:49"}', '2026-01-15 15:06:49.847842')
ON CONFLICT (id) DO NOTHING;
