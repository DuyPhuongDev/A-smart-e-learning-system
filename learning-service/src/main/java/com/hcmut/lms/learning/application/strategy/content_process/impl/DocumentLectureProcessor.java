...
import com.hcmut.lms.learning.application.service.DocumentEnrichmentService;
import com.hcmut.lms.learning.application.service.DocumentEnrichmentService.EnrichedDocumentChunk;
import com.hcmut.lms.learning.application.service.DocumentEnrichmentService.EnrichmentResult;
import com.hcmut.lms.learning.application.service.DocumentEnrichmentService.PageSegment;
...
import com.hcmut.lms.learning.application.strategy.document_parser.DocumentParserFactory;
...
import com.hcmut.lms.learning.client.dto.DocumentDownloadUrlResponse;
import com.hcmut.lms.learning.config.DocumentProcessingConfig;
    ...
    public ExtractedContent extractContent(ProcessingContext context) throws ContentProcessingException {
        ...
        try {
            ...
            DocumentDownloadUrlResponse downloadResponse =
                    courseManagementClient.getDocumentDownloadUrl(context.getLectureId());
