...
import com.hcmut.lms.learning.application.service.*;
import com.hcmut.lms.learning.application.strategy.content_process.ContentProcessor;
import com.hcmut.lms.learning.application.strategy.content_process.ContentProcessorFactory;
...
public class DocumentProcessingServiceImpl implements DocumentProcessingService {
    ...
    @Value("${processing.enhance-text:true}")
    ...
    public ProcessingStatusResponse processLecture(ProcessLectureRequest request) {
        ...
        // Create LectureKnowledge entity (using lectureId as primary key for 1:1 relationship)
