...
import com.hcmut.lms.learning.client.dto.TextLectureContentResponse;
    ...
    public ExtractedContent extractContent(ProcessingContext context) throws ContentProcessingException {
        ...
        try {
            ...
            if (textContent == null || textContent.isBlank()) {
                ...
                TextLectureContentResponse response =
                        courseManagementClient.getTextLectureContent(context.getLectureId());
