...
import com.hcmut.lms.learning.application.mapper.LectureKnowledgeChunkMapper;
...
import com.hcmut.lms.learning.domain.repository.LectureKnowledgeChunkRepository;
import com.hcmut.lms.learning.domain.repository.LectureKnowledgeRepository;
...
public class LectureKnowledgeChunkServiceImpl implements LectureKnowledgeChunkService {
    ...
    @Override
    public LectureKnowledgeChunkResponse createChunk(UUID lectureKnowledgeId, CreateLectureKnowledgeChunkRequest request) {
    ...
    public List<LectureKnowledgeChunkResponse> getChunksByLectureKnowledgeId(UUID lectureKnowledgeId) {
        List<LectureKnowledgeChunk> chunks = chunkRepository.findByLectureKnowledgeLectureKnowledgeId(lectureKnowledgeId);
    ...
    public List<LectureKnowledgeChunkResponse> getChunksByLectureKnowledgeIdOrderByIndex(UUID lectureKnowledgeId) {
        List<LectureKnowledgeChunk> chunks = chunkRepository.findByLectureKnowledgeLectureKnowledgeIdOrderByChunkIndexAsc(lectureKnowledgeId);
        return chunks.stream()
            .map(chunkMapper::toResponse)
            .collect(Collectors.toList());
    }
