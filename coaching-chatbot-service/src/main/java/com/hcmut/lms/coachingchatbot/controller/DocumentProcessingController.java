...
import com.hcmut.lms.coachingchatbot.application.service.DocumentProcessingService;
...
public class DocumentProcessingController {
    ...
    public ResponseEntity<ProcessingStatusResponse> getProcessingStatusByKnowledgeId(
        ...
        ProcessingStatusResponse response = documentProcessingService
                .getProcessingStatusByKnowledgeId(lectureKnowledgeId);
        return ResponseEntity.ok(response);
    }
